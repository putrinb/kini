        ...
        <div class="container-fluid">
            ...
            <div class="card card-light">
                <div class="card-header">
                    <h3 class="card-title">Edit Data Penggunaan</h3>
                </div>

                <form action="" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                        <input type="hidden" name="id" class="form-control" value="<?= $bop['id'] ?>">
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>Nama Penggunaan</label><span class="text-danger">*</span>
                                        <input name="penggunaan" type="text" maxlength="50" class="form-control" value="<?php echo $bop['penggunaan'] ?>" placeholder="Masukkan Penggunaan">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="daya" id="watt" class="form-control watt" maxlength="30" value="<?php echo $bop['daya_watt'] ?>" placeholder="65">

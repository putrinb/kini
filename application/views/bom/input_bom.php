        ...
        <div class="container-fluid">
            ...
            <div class="card card-light">
              ...
              <!-- <div class="card-tools">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="<?php echo site_url('bom/add') ?>" method="post"> 
                            <div class="row">
                                <div class="col-6">
                                <!-- text input -->
                                    <div class="form-group">
                                        <label for="id_bom">No. BOM<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="id_bom" readonly value="<?php echo $id_bom; ?>">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label for="id_produk">Nama Produk
                                        ...
                                        <option value="">- None -</option>
                                            ...
                                            <option value="<?php echo $row['id_produk']?>"><?php echo $row['id_produk']?> - <?php echo $row['nama_produk']?></option>
                                                ...
                                                endforeach;
                                                ?>
                                        </select><?php echo "<b>".form_error('id_produk')."</b>"; ?>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="row">

...
<div class="register-box">
  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="<?=site_url('users/insert');?>" method="post">
      <?=form_error('nama_user');?>
        <div class="input-group mb-3">
          <input type="text" name="nama_user" class="form-control" value="<?=set_value('nama_user');?>" placeholder="Full name">
        ...
        <div class="input-group mb-3">
          <input type="password" name="confirm_password" class="form-control" value="<?=set_value('confirm_password');?>" placeholder="Retype password">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
